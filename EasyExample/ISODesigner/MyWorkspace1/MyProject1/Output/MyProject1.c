...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 11, 0, 
		...
		XYREF(InputNumber_Gesamtzaehler, 8, 438),
		XYREF(Button_MinusMinus, 369, 376),
		XYREF(InputNumber_Tagesziel, 10, 180),
		XYREF(InputNumber_Gesamtziel, 173, 183),
	...
	ID(SoftKey_Minus_Minus), TYPEID_SOFTKEY, COLOR(187), 1, 1, 0, 
		XYREF(OutputString_11006, 5, 22),
	ID(Button_PlusPlus), TYPEID_BUTTON, WORD(94), WORD(88), 187, 144, 1, 0, 1, 0, 
		XYREF(OutputString_PlusPlus, 5, 24),
	...
	ID(Button_MinusMinus), TYPEID_BUTTON, WORD(94), WORD(88), 187, 144, 1, 0, 1, 0, 
		XYREF(OutputString_MinusMinus, 9, 32),
	...
	ID(InputNumber_Tagesziel), TYPEID_INNUM, WORD(144), WORD(32), COLOR(211), ID(FontAttributes_Default), 0, 
		ID(NumberVariable_Tagesziel), LONG(0UL), LONG(0UL), LONG(65535UL), LONG(0L), FLOAT_1, 0, 0, 2, 1, 0, 
	ID(InputNumber_Gesamtziel), TYPEID_INNUM, WORD(126), WORD(33), COLOR(191), ID(FontAttributes_Default), 0, 
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(80), WORD(40), COLOR_WHITE, ID(FontAttributes_Button), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(70), WORD(29), COLOR(187), ID(FontAttributes_Button), 0,
		ID(ID_NULL), 0, WORD(4), '-', '-', ' ', ' ', 0,
	ID(OutputString_MinusMinus), TYPEID_OUTSTR, WORD(80), WORD(32), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(4), '-', '-', ' ', ' ', 0,
	ID(OutputString_11008), TYPEID_OUTSTR, WORD(85), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(4), '-', '-', ' ', ' ', 0,
	...
	ID(Button_MinusMinus1), TYPEID_BUTTON, WORD(85), WORD(81), 249, 249, 1, 0, 1, 0, 
		XYREF(OutputString_11008, -4, 27),
	...
	ID(FontAttributes_Button), TYPEID_FONTATTR, COLOR_BLACK, 5, 0, 0, 0, 
